...
<div id="j2store-search-<?php echo $module->id;?>" class="j2store-search-product  <?php echo $moduleclass_sfx;?>" >
	<form action="<?php echo $url;?>" method="" class="form-horizontal" name="j2storeserachForm" id="j2storeserachForm_<?php echo $module->id;?>" >
		...
		<?php if ($params->get('show_label', 1) == 1): ?>
			<label for="mod_j2store_search"><?php echo JText::_('J2STORE_MOD_FILTER_SEARCH'); ?></label>
		<?php endif; ?>
		<input type="text" class="inputbox" name="search" id="mod_j2store_search-<?php echo $module->id; ;?>" value="<?php echo $search;?>"  placeholder="<?php echo JText::_('J2STORE_MOD_FILTER_SEARCH'); ?>"/>
